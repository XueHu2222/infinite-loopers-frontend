...
<section class="relative grid place-items-center w-screen border-b-2 border-[#4F3117]" style="background-image: url({sky}); background-size: cover;">
